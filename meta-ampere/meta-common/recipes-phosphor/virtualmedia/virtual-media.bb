...
SRC_URI += " \
             file://0001-Fix-fail-to-Insert-and-Eject-media.patch \
             file://0002-Fix-build-error-with-boost-1.86.patch \
             file://0003-Fix-build-error-with-boost-1.87.patch \
             file://0004-Always-use-pipe-for-username-and-password.patch \
             file://0005-Fix-build-error-with-boost-1.88.patch \
...
do_install:append() {
    install -m 0644 ${UNPACKDIR}/virtual-media.json ${D}${sysconfdir}
}
